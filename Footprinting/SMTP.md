...
```
XXXXXXXXXX@htb[/htb]$ cat /etc/postfix/main.cf | grep -v "#" | sed -r "/^\s*$/d"
...
## Telnet - HELO/EHLO
```
XXXXXXXXXX@htb[/htb]$ telnet 10.129.14.128 25
...
## Telnet - VRFY
```
XXXXXXXXXXXXX@htb[/htb]$ telnet 10.129.14.128 25
...
```
XXXXXXXXXXXXXX@htb[/htb]$ sudo nmap 10.129.14.128 -sC -sV -p25
...
```
```
XXXXXXXXXXXXXX@htb[/htb]$ sudo nmap 10.129.14.128 -p25 --script smtp-open-relay -v
