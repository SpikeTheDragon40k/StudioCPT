# Vulnerable Services Exploitation Example

In this example we exploit the popular terminal multiplexer [Screen](https://linux.die.net/man/1/screen) Version 4.5.0 suffers from a privilege escalation vulnerability due to a lack of a permissions check when opening a log file.

## Screen Version Identification
```bash
AdrianoInghihwg@htb[/htb]$ screen -v
...
```bash
AdrianoInghihwg@htb[/htb]$ ./screen_exploit.sh 
