...
```bash
Adriano@htb[/htb]$ more /etc/passwd
```
...
```bash
Adriano@htb[/htb]$ less /etc/passwd
```
...
```bash
Adriano@htb[/htb]$ head /etc/passwd
...
```bash
Adriano@htb[/htb]$ tail /etc/passwd
...
```bash
Adriano@htb[/htb]$ cat /etc/passwd | sort
...
```bash
Adriano@htb[/htb]$ cat /etc/passwd | grep "/bin/bash"
...
```bash
Adriano@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin"
...
```bash
Adriano@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | cut -d":" -f1
...
```bash
Adriano@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " "
...
```bash
Adriano@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " " | column -t
...
```bash
Adriano@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " " | awk '{print $1, $NF}'
...
```bash
Adriano@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " " | awk '{print $1, $NF}' | sed 's/bin/HTB/g'
...
```bash
Adriano@htb[/htb]$ cat /etc/passwd | grep -v "false\|nologin" | tr ":" " " | awk '{print $1, $NF}' | wc -l
